...
CREATE TABLE "User" (
    ...
    "notifyInteractions" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "Post" (
    ...
    "proofIssuedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "Post_proofHash_key" ON "Post"("proofHash");
