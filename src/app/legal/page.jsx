...
export const metadata = {
  title: "Điều khoản, Quyền riêng tư & Bản quyền | Nhật ký ngày đi câu",
...
const sections = [
  {
    title: "Vai trò của Nhật ký ngày đi câu",
    icon: Fingerprint,
    paragraphs: [
      "Nhật ký ngày đi câu là nền tảng công nghệ cho phép influencer và nhà sáng tạo tải nội dung gốc lên trước khi công bố tại nền tảng khác. Hệ thống ghi nhận tài khoản đăng tải, thời điểm máy chủ tiếp nhận, dấu vân tay SHA-256 và dữ liệu liên quan để hỗ trợ chứng minh lịch sử tồn tại của nội dung.",
      "Bản ghi Nhật ký ngày đi câu là một nguồn chứng cứ kỹ thuật. Bản ghi không tự tạo ra quyền tác giả, không thay thế Giấy chứng nhận đăng ký quyền tác giả, công chứng, giám định, chữ ký số hoặc dịch vụ chứng thực thời gian được cấp phép. Giá trị chứng minh cuối cùng do nền tảng tiếp nhận khiếu nại, cơ quan có thẩm quyền hoặc tòa án đánh giá.",
    ],
  },
  {
    ...
    icon: ShieldCheck,
    paragraphs: [
      "Người dùng giữ quyền sở hữu đối với nội dung hợp pháp do mình tạo. Khi tải nội dung lên, người dùng cấp cho Nhật ký ngày đi câu giấy phép không độc quyền, có thể thu hồi theo phạm vi pháp luật cho phép, để lưu trữ, sao lưu, tạo bản xem trước, hiển thị theo chế độ riêng tư đã chọn và xử lý nội dung nhằm vận hành dịch vụ.",
      ...
      "Nhật ký ngày đi câu không sử dụng nội dung riêng tư để quảng cáo, huấn luyện mô hình AI hoặc bán cho bên thứ ba nếu chưa có đồng ý riêng, rõ ràng của chủ thể quyền.",
    ],
  },
  {
    ...
    paragraphs: [
      "Mỗi lần xuất bản có thể tạo dấu SHA-256 gắn với nội dung, tệp, tác giả, thời điểm và giá trị ngẫu nhiên chống trùng. Dấu này giúp phát hiện thay đổi và đối chiếu bản ghi đã lưu tại Nhật ký ngày đi câu.",
      "Nhật ký ngày đi câu chỉ xác nhận hệ thống đã tiếp nhận phiên bản nội dung tại thời điểm ghi nhận. Nhật ký ngày đi câu không mặc nhiên xác nhận người tải lên là tác giả đầu tiên, nội dung hoàn toàn nguyên gốc hoặc không có tranh chấp trước đó.",
  ...
  {
    title: "Dữ liệu Nhật ký ngày đi câu thu thập",
    icon: Database,
    paragraphs: [
      "Dữ liệu tài khoản gồm tên đăng nhập, email, tên hiển thị, mật khẩu đã băm, vai trò, trạng thái và liên kết kênh mạng xã hội. Nhật ký ngày đi câu không lưu mật khẩu dạng rõ.",
  ...
  },
  {
    ...
    icon: UserFocus,
    paragraphs: [
      "Nhật ký ngày đi câu xử lý dữ liệu để xác thực tài khoản, vận hành bảng tin, lưu bản gốc, tạo chứng cứ kỹ thuật, hỗ trợ khiếu nại bản quyền, phòng chống gian lận, bảo mật hệ thống, thực hiện nghĩa vụ pháp lý và cải thiện tính ổn định của dịch vụ.",
      "Dữ liệu chỉ được truy cập bởi nhân sự hoặc nhà cung cấp cần thiết cho mục đích nêu trên, theo nguyên tắc phân quyền tối thiểu. Nhật ký ngày đi câu không bán dữ liệu cá nhân.",
      "Nếu cần xử lý cho mục đích mới không tương thích, Nhật ký ngày đi câu sẽ thông báo và xin đồng ý khi pháp luật yêu cầu.",
    ],
  },
  {
    ...
    icon: FileLock,
    paragraphs: [
      "Nhật ký ngày đi câu có thể sử dụng nhà cung cấp hạ tầng, lưu trữ, sao lưu, email, bảo mật và phân tích lỗi. Các bên này chỉ được xử lý dữ liệu theo chỉ dẫn và nghĩa vụ bảo mật phù hợp.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Khi bài viết hoặc tài khoản bị xóa, bản công khai sẽ bị gỡ theo quy trình kỹ thuật. Nhật ký ngày đi câu có thể giữ tối thiểu nhật ký kiểm toán, dấu băm và thông tin cần thiết để điều tra lạm dụng hoặc bảo vệ yêu cầu pháp lý; phần lưu giữ này không được dùng để tái xuất bản nội dung.",
      "Người dùng có thể yêu cầu truy cập, sửa, rút lại đồng ý, hạn chế xử lý hoặc xóa dữ liệu. Một số yêu cầu có thể bị giới hạn khi Nhật ký ngày đi câu phải lưu dữ liệu theo luật hoặc để bảo vệ quyền hợp pháp trong tranh chấp.",
    ],
  },
  {
    ...
    icon: ShieldCheck,
    paragraphs: [
      "Nhật ký ngày đi câu áp dụng kiểm soát truy cập, băm mật khẩu, cookie phiên an toàn, giới hạn đăng nhập, kiểm tra tệp tải lên, nhật ký quản trị, sao lưu và mã hóa đường truyền HTTPS khi triển khai chính thức.",
      "Không hệ thống nào an toàn tuyệt đối. Khi xảy ra sự cố có nguy cơ ảnh hưởng quyền của chủ thể dữ liệu, Nhật ký ngày đi câu sẽ cô lập sự cố, đánh giá phạm vi, lưu bằng chứng và thực hiện thông báo theo thời hạn luật định.",
  ...
  },
  {
    ...
    icon: Gavel,
    paragraphs: [
      "Thông báo vi phạm cần nêu thông tin người gửi, tác phẩm được bảo hộ, URL/nội dung bị khiếu nại, căn cứ quyền sở hữu, tài liệu đối chiếu và cam kết thông tin trung thực. Nhật ký ngày đi câu có thể yêu cầu bổ sung dữ liệu trước khi xử lý.",
      "Nhật ký ngày đi câu có thể tạm ẩn nội dung trong thời gian xác minh, chuyển thông báo cho người đăng và tiếp nhận phản hồi. Tài khoản tái phạm hoặc cố ý gửi khiếu nại sai có thể bị hạn chế hay đình chỉ.",
...
export default function LegalPage() {
  const operatorName = process.env.NEXT_PUBLIC_LEGAL_ENTITY_NAME || "Đơn vị vận hành Nhật ký ngày đi câu"
    ...
    <div className="min-h-[100dvh] bg-background pb-20 pt-16">
      ...
      <main id="main-content" className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-muted-foreground sm:text-base">
                Quy định cách Nhật ký ngày đi câu tiếp nhận bản gốc, tạo dấu chứng cứ kỹ thuật và bảo vệ dữ liệu của nhà sáng tạo trước khi nội dung được phát hành rộng rãi.
              </p>
            </div>
        ...
        <section className="mt-5 flex gap-3 rounded-2xl border border-amber-400/25 bg-amber-400/8 p-4 text-sm leading-6 text-foreground/85">
          ...
          <p><strong>Thông tin quan trọng:</strong> Nhật ký ngày đi câu cung cấp bản ghi chứng cứ kỹ thuật, không phải cơ quan đăng ký quyền tác giả, văn phòng công chứng, tổ chức giám định hoặc nhà cung cấp dịch vụ chứng thực thời gian được cấp phép.</p>
        </section>
        ...
        <div className="mt-5 text-center"><Link href="/" className="text-sm font-bold text-primary hover:underline">Quay lại bảng tin Nhật ký ngày đi câu</Link></div>
      </main>
    </div>
  )
}
